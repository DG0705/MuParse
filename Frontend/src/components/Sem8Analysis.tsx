...
const Sem8Analysis: React.FC = () => {
  ...
  // --- Fetch Data from Backend (Semester 8) ---
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        setLoading(true);
  ...
  const summary: SummaryData = useMemo(() => {
    ...
    const teacherAssignment: { [key: string]: string } = {
      "BIG DATA ANALYTICS": "XYZ",
      "BLOCKCHAIN AND DLT": "XYZ",
      "BLOCKCHAIN LAB": "XYZ",
      "CLOUD COMPUTING LAB": "XYZ",
      ERP: "XYZ",
      "KNOWLEDGE MANAGEMENT": "XYZ",
      "MAJOR PROJECT II": "XYZ",
      "PROJECT MANAGEMENT": "XYZ",
    };
