...
const Sem1BlockConverter = () => {
  ...
  const handleProcess = async () => {
    ...
    formData.append("semester", "1"); // Hardcoded to Semester 1
      ...
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight">
                Semester 1 Data Extractor
              </h1>
              <p className="text-muted-foreground">
                Standalone extraction tool for Sem 1 (11 Papers)
              </p>
            </div>
          </div>
        </header>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload the Semester 1 result PDF for processing
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() => {
                    ...
                    a.href = url;
                    a.download = `sem1_extracted.json`;
                    a.click();
                  }}
                >
                  Download JSON
...
export default Sem1BlockConverter;