...
const Sem2Analysis = () => {
  ...
  const [selectedBatch, setSelectedBatch] = useState(""); // Starts empty to catch server default
  const [isLoading, setIsLoading] = useState(true);
  const lastFetchedBatch = useRef(null);

  // Mapped strictly to Sem 2 Core Subjects
  ...
  useEffect(() => {
    // Prevent React double-fetching loops
    ...
    fetch(`http://localhost:5000/api/students/sem/2${queryParam}`)
      .then((res) => res.json())
      .then((res) => {
        setData(res);
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="p-10 text-center text-blue-600 font-bold text-xl animate-pulse">
          Loading Official Gazette (Sem 2)...
        </div>
      </div>
    );
  }
  ...
  // Clean UI mapping for official MU First Year Sem 2 Subjects
  const cleanSubjectNames = {
    Eng_Maths_II_Marks: "Engg Mathematics-II",
    Eng_Physics_II_Marks: "Engg Physics-II",
    Eng_Chem_II_Marks: "Engg Chemistry-II",
    Eng_Graphics_Marks: "Engg Graphics",
    C_Prog_Marks: "C-Programming",
  };
        ...
        <>
          ...
          <div className="text-center mb-8 leading-tight">
            ...
            <h3 className="text-xl font-bold text-gray-900">
              RESULT ANALYSIS F.E. SEMESTER II (BATCH: {selectedBatch})
            </h3>
              ...
              <tbody>
                {data.analysis.subjectAnalysis.map((sub, idx) => {
                  ...
                  return sub.topScorers.map((scorer, i) => (
                    ...
                    >
                      <td className="border border-black p-1.5 text-center font-bold bg-white text-gray-800">
                        {displayName}
                      </td>
                    ...
                    <tr key={idx} className="hover:bg-gray-50 group">
                      ...
                      <td className="border border-black p-0 text-left relative">
                        <input
                          ...
                          className="w-full h-full px-3 py-2 bg-transparent focus:outline-none focus:bg-yellow-50 font-medium text-gray-900"
          ...
          {/* CHARTS SECTION (DUAL CHARTS RESTORED) */}
          <div className="flex flex-col items-center gap-16 mb-16 print:mt-10">
            ...
            <div className="w-full max-w-4xl border-l-[20px] border-b-[20px] border-[#4f81bd] p-8 relative bg-white shadow-md print:border-l-[10px] print:border-b-[10px] print:shadow-none print:break-inside-avoid">
              ...
              <div className="absolute -left-12 top-1/2 -rotate-90 font-bold text-gray-700 uppercase text-xs">
                Students
              </div>
            ...
            <div className="w-full max-w-4xl border-l-[20px] border-b-[20px] border-[#4f81bd] p-8 relative bg-white shadow-md print:border-l-[10px] print:border-b-[10px] print:shadow-none print:break-before-page print:mt-10">
              ...
              <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 font-bold text-gray-700 uppercase text-xs">
                Name of Subject
              </div>
