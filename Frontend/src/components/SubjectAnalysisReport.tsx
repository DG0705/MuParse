          ...
          <tbody>
            {Object.entries(analysisData).map(([subject, stats]) => (
              <tr key={subject} className="even:bg-gray-50">
                ...
                <td className="p-2 border border-black text-center">{stats.totalPassed}</td>
                <td className="p-2 border border-black font-bold text-green-700 text-center">
                  {stats.passPercentage}
                </td>
                <td className="p-2 border border-black text-center">{stats.marks40_50}</td>
                <td className="p-2 border border-black text-center">{stats.marks51_59}</td>
                <td className="p-2 border border-black text-center">
                  {stats.marks60_Above}
                </td>
              </tr>
